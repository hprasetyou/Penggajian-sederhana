...
Public Class gaji_bulan_ini
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "penghitungan_gaji.gaji bulan ini.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedgaji_bulan_ini
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As gaji_bulan_ini = New gaji_bulan_ini()
        rpt.Site = Me.Site
        Return rpt
    End Function
